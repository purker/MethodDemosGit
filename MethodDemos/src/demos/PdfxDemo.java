...
public class PdfxDemo extends AbstractDemo
{
	...
	// Example:
	// curl -s --data-binary @'D:\output\GroundTruth\Beitr�geausTagungsb�nden\TUW-137078.pdf' -H 'Content-Type: application/pdf' -L 'http://pdfx.cs.man.ac.uk' -o 'D:\output\PDFX\TUW-137078.xml'
	...
	public static void main(String[] args) throws ExecuteException, IOException
	{
		...
		new PdfxDemo().runDemoList(files, Demos.pdfxOutputDir);
	}
